class Solution:
    def remainingMethods(self, n: int, k: int, invocations: List[List[int]]) -> List[int]:
        ...
        def dfs(node):
            # this node is the "suspicious node we start with k"
            infected.add(node)  
        ...
        dfs(k) # start from the suspicious node
...
# submission 2095309453 - 2026-08-05T12:43:46+00:00
class Solution:
    def remainingMethods(self, n: int, k: int, invocations: List[List[int]]) -> List[int]:
...
# submission 2095313355 - 2026-08-05T12:47:44+00:00
class Solution:
    def remainingMethods(self, n: int, k: int, invocations: List[List[int]]) -> List[int]:
