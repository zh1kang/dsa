...
# submission 2105647176 - 2026-08-13T16:06:02+00:00
class Solution:
    def longestRepeating(self, s: str, queryCharacters: str, queryIndices: List[int]) -> List[int]:
        # so we have queryIndicies which tells us which character in string s will be updated
        # and thne the ith query is what character we will update the string s[queryIndicies[i]] with in queryCharacters[i]
...
# submission 2105647436 - 2026-08-13T16:06:14+00:00
class Solution:
    def longestRepeating(self, s: str, queryCharacters: str, queryIndices: List[int]) -> List[int]:
        # so we have queryIndicies which tells us which character in string s will be updated
        # and thne the ith query is what character we will update the string s[queryIndicies[i]] with in queryCharacters[i]
...
# submission 2105648067 - 2026-08-13T16:06:45+00:00
class Solution:
    def longestRepeating(self, s: str, queryCharacters: str, queryIndices: List[int]) -> List[int]:
        # so we have queryIndicies which tells us which character in string s will be updated
        # and thne the ith query is what character we will update the string s[queryIndicies[i]] with in queryCharacters[i]
...
# submission 2105654538 - 2026-08-13T16:11:51+00:00
class Solution:
    def longestRepeating(self, s: str, queryCharacters: str, queryIndices: List[int]) -> List[int]:
        # so we have queryIndicies which tells us which character in string s will be updated
        # and thne the ith query is what character we will update the string s[queryIndicies[i]] with in queryCharacters[i]
        ...
        def merge(left, right):
            # unpack the two child summaries:
            l_char, l_right, l_prefix, l_suffix, l_best, l_len = left
            r_left, r_char, r_prefix, r_suffix, r_best, r_len = right
