...
# submission 2102843635 - 2026-08-11T13:01:38+00:00
class Solution:
    def findMinHeightTrees(self, n: int, edges: List[List[int]]) -> List[int]:
        ...
        return list(queue) # O(n)



        

# submission 2102845032 - 2026-08-11T13:02:48+00:00
class Solution:
    def findMinHeightTrees(self, n: int, edges: List[List[int]]) -> List[int]:
        ...
        return 0 if n == 1 else list(queue)  # O(n)



        

# submission 2102845349 - 2026-08-11T13:03:03+00:00
class Solution:
    def findMinHeightTrees(self, n: int, edges: List[List[int]]) -> List[int]:
...
# submission 2102853852 - 2026-08-11T13:10:03+00:00
class Solution:
    def findMinHeightTrees(self, n: int, edges: List[List[int]]) -> List[int]:
